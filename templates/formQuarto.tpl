    ...
    <div class="border p-4 mx-auto bg-white" style="max-width: 400px;">
        ...
        <form action="formQuarto/save" method="post">
            ...
            <div class="form-group">
                ...
                <input type="radio" name="ocupado" {if $model->ocupado === 1}checked{/if} value='Sim' required>
                Sim<br>
                <input type="radio" name="ocupado" {if $model->ocupado === 0}checked{/if} value='Não' required> Não
            </div>
            <div class="col-mb-3">
