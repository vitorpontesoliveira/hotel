...
{block name=main}
    <div class="border p-4 mx-auto bg-white" style="max-width: 400px;">
        ...
        <form action="formCliente/save" method="post">
            <input type="hidden" value="{$params->clienteId}" name="clienteId">
            <div class="mb-3">
                <label for="nome" class="form-label">Nome:</label>
                <input type="text" value="{$params->nome}" class="form-control" name="nome" id="nome"
            ...
            <div class="mb-3">
                ...
                <input type="email" value="{$params->email}" class="form-control" name="email" id="email"
